                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input required="" type="text" value="${account.getFullName()}" name="fullname" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input required="" type="text" value="${account.getEmail()}"  name="email" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input required="" type="password" value="${account.getPassword()}" name="pass" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="gender">
                                                            <option value="Male"  ${account.isGender() == true ? "selected" : ""}>Male</option>
                                                            <option value="Female"  ${account.isGender() == false ? "selected" : ""}>Female</option>
                                                        </select>
                                                    </div>
                                                </div>
