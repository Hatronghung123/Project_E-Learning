...
<html>
    <head>
        ...
        .bi.bi-suit-heart {
            ...
            height: 24px;
            display: inline-block;
            background-color:rgb(6, 187, 204) ; /* Màu nền xám */
            border-radius: 50%; /* Tạo nền hình tròn */
            display: flex;
            align-items: center;
            justify-content: center;
            color: white; /* Màu của biểu tượng */
            font-size: 18px; /* Kích thước biểu tượng, có thể điều chỉnh */
        }
                    ...
                    <c:forEach var="o" items="${listCourseByCategory}">
                        <div class="col-lg-4 col-md-6 wow fadeInUp"  data-wow-delay="0.3s" style="padding-bottom: 20px;">
                            <div class="course-item bg-light"   >
                                ...
                                <div class="text-center pb-0" style="padding-left: 16px;padding-right: 16px;padding-bottom: 16px" >
