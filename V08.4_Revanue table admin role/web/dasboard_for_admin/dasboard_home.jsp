            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ListManagerAccount.jsp">Manager Account</a>
                        <a class="collapse-item" href="utilities-border.html">Mentor Account</a>
                        <a class="collapse-item" href="utilities-animation.html">Mentee Account</a>
