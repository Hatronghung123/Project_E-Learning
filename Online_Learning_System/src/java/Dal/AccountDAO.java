...
//        Account account = new Account("cao", "123", "cao1@gmail.com",1000,"abv");
    ...
    public Account getAccountByEmailPass(String email, String password) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                return new Account(account_id, email_in_db, password_in_db, role_id, active);
            }
    ...
    public void insertAccount(Account account) {
        connection = getConnection();
        String sql_account = "INSERT INTO [dbo].[Account]\n"
                + "           ([Email]\n"
                + "           ,[Password]\n"
                + "           , [Status]\n"
                + "           ,[Role_id]\n"
    ...
    public void insertProfile(Profile profile, int account_id) {
        connection = getConnection();
        String sql_profile = "INSERT INTO Profile\n"
                + "           ([Fullname]\n"
                + "           ,[Gender]\n"
                + "           ,[Account_id]\n"
                + "           ,[Avatar]\n"
        ...
        try {
            ...
            statement.setInt(6, profile.getManaged_by());
            // thực thi câu lệnh
            statement.executeUpdate();
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    public Profile getProfile(Account account_login) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                int manageBy = resultSet.getInt(7);
    ...
    public boolean checkAccountExist(String email) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                Account accountCheckIsExit = new Account(account_id, email, password, role_id, active);
