        ...
        try {
            ...
            while (rs.next()) {
                ...
                int course_id = rs.getInt(9);
                 int profile_id = rs.getInt(10);
                list.add(new Lesson(lesson_id, modulname, lesson_name, lesson_content, lesson_video, course_name, mentor_name, Avatar, course_id,profile_id));
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Lesson getlessonByCid(int courseId, int lessonid) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                return new Lesson(lesson_id, modulname, lesson_name, lesson_content, lesson_video, course_name, mentor_name, Avatar, course_id, profile_id);
            }
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("Lỗi");
